  ...
  return (
   <main className="bg-purple-400">
    <section className="grid grid-cols-2 h-[50vh]">
      ...
      <Image className="mix-blend-darken" alt="pic" src="/skybox.jpg" fill priority sizes="(max-width: 768px) 100vw, 50vw"  style={{ objectFit: 'cover' }}/>
      </div>
    </section>
    <section className="relative grid h-[50vh]">
    <div className="flex flex-col gap-4 items-center justify-center">
        ...
        <Link href="/search"><button className='bg-purple-500 rounded-lg p-3 py-1 font-bold text-white'>Search Now</button></Link>
        <Link href="/shorten"><button className='bg-purple-500 rounded-lg p-3 py-1 font-bold text-white'>Short Now</button></Link>
        {/* <Image src="/skybox.jpg" alt="Background Image" layout="fill" objectFit="cover" className="mix-blend-darken"/> */}
        </div>
      </div>      
    </section>
   </main>
